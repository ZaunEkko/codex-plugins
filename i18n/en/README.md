...
| commit-commands | Plugin + Skills + UserPromptSubmit Hook | Attributes commits with separated paragraphs, safely transfers GitHub.com/GitHub Enterprise PR bodies through UTF-8 files, verifies `Generated with [Codex](https://chatgpt.com/codex)`, and preserves force cleanup. | [Plugin docs](docs/commit-commands/README.md) |
