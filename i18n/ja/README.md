...
| commit-commands | Plugin + Skills + UserPromptSubmit Hook | commit にモデルと effort を記録し、PR body の `Generated with [Codex](https://chatgpt.com/codex)` を検証し、force cleanup を維持します。 | [プラグイン docs](docs/commit-commands/README.md) |
