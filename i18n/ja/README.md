...
| commit-commands | Plugin + Skills + UserPromptSubmit Hook | commit に現在の Codex モデルを記録し、Anthropic 原版の gone ブランチ force cleanup を維持します。 | [プラグイン docs](docs/commit-commands/README.md) |
