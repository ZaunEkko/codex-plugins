...
| commit-commands | Plugin + Skills + UserPromptSubmit Hook | commit に現在の Codex モデルと reasoning effort を記録し、force cleanup を維持します。 | [プラグイン docs](docs/commit-commands/README.md) |
