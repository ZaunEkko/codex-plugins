...
| commit-commands | Plugin + Skills + UserPromptSubmit Hook | 以分段格式標註提交模型與思考強度、透過 UTF-8 檔案安全傳遞 GitHub.com/GitHub Enterprise PR 正文並驗證 `Generated with [Codex](https://chatgpt.com/codex)`，同時保留 gone 分支 force 清理。 | [插件文件](docs/commit-commands/README.md) |
