...
| commit-commands | Plugin + Skills + UserPromptSubmit Hook | 為提交標註模型與思考強度、驗證 GitHub.com/GitHub Enterprise PR 正文的 `Generated with [Codex](https://chatgpt.com/codex)`，並保留 gone 分支 force 清理。 | [插件文件](docs/commit-commands/README.md) |
