...
| commit-commands | Plugin + Skills + UserPromptSubmit Hook | commit 에 모델과 effort 를 기록하고 PR body 의 `Generated with [Codex](https://chatgpt.com/codex)` 를 검증하며 force 정리를 유지합니다. | [플러그인 문서](docs/commit-commands/README.md) |
